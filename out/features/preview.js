...
class RSTPreview {
    constructor(webview, resource, locked, _contentProvider, _previewConfigurations, _logger, topmostLineMonitor) {
        ...
        vscode.window.onDidChangeActiveTextEditor(editor => {
            if (editor && (0, file_1.isRSTFile)(editor.document) && !this._locked) {
    ...
    get iconPath() {
        const root = path.join((0, extension_1.getExtensionPath)(), 'media');
        return {
    ...
    static getLocalResourceRoots(resource) {
        const baseRoots = [vscode.Uri.file((0, extension_1.getExtensionPath)() + "/media")];
...
RSTPreview.viewType = 'rst.preview';
