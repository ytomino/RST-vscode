...
class OpenDocumentLinkCommand {
    ...
    async tryOpen(path, args) {
        ...
        if (vscode.window.activeTextEditor && (0, file_1.isRSTFile)(vscode.window.activeTextEditor.document) && vscode.window.activeTextEditor.document.uri.fsPath === resource.fsPath) {
